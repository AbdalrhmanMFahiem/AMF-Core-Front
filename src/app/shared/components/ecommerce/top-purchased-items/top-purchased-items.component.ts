    ...
    <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-3.5 sm:p-4 shadow-xs">
      <div class="flex items-center justify-between mb-3 pb-2.5 border-b border-gray-100 dark:border-gray-800">
        <div class="flex items-center gap-2.5">
          <div class="p-2 rounded-lg bg-emerald-500/10 text-emerald-500 dark:bg-emerald-500/20">
        ...
        <span class="text-[11px] font-medium px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-500 dark:bg-emerald-500/20">
      ...
      <div *ngIf="!loading && items.length > 0" class="space-y-2">
        <div *ngFor="let item of items; let i = index" class="p-2.5 rounded-lg bg-gray-50/50 dark:bg-gray-800/30 border border-gray-100 dark:border-gray-800/80 flex items-center justify-between">
          <div class="flex items-center gap-2.5">
            <span class="w-6 h-6 rounded-md text-[11px] font-bold flex items-center justify-center bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">
              #{{ i + 1 }}
            </span>
            <div>
          ...
          <div class="text-left">
            <span class="text-xs font-extrabold text-emerald-600 dark:text-emerald-400 block">
              {{ item.purchasedQuantity | number:'1.0-2' }} {{ item.unitName }}
            </span>
            <span class="text-[11px] text-gray-500 dark:text-gray-400 font-semibold">
