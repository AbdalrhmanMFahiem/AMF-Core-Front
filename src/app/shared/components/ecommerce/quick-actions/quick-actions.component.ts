...
@Component({
  ...
  template: `
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4">
      <a routerLink="/sales/invoices/new" class="group p-4 bg-gradient-to-br from-blue-500/10 via-blue-500/5 to-transparent border border-blue-500/20 dark:border-blue-500/30 rounded-2xl hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 flex flex-col items-start gap-3">
      ...
      <a routerLink="/purchases/invoices/new" class="group p-4 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent border border-emerald-500/20 dark:border-emerald-500/30 rounded-2xl hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300 flex flex-col items-start gap-3">
      ...
      <a routerLink="/inventory/items/new" class="group p-4 bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-transparent border border-amber-500/20 dark:border-amber-500/30 rounded-2xl hover:shadow-lg hover:shadow-amber-500/10 transition-all duration-300 flex flex-col items-start gap-3">
      ...
      <a routerLink="/inventory/stock-transfer" class="group p-4 bg-gradient-to-br from-purple-500/10 via-purple-500/5 to-transparent border border-purple-500/20 dark:border-purple-500/30 rounded-2xl hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 flex flex-col items-start gap-3">
