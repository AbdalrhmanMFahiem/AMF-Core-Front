...
export class DocumentStatusBadgeComponent {
  ...
  getBadgeClasses(): string {
    ...
    if (this.isClosed()) return 'bg-slate-100 text-slate-800 dark:bg-slate-800/60 dark:text-slate-300 border border-slate-300 dark:border-slate-700';
    if (this.isCancelled()) return 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400 border border-red-200 dark:border-red-800';
